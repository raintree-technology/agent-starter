# Claude Code MCP Expert Full Guide
...
- [Process](#process)
  ...
  - [2. Choose Server Type](#2-choose-server-type)
  ...
  - [4. Configuration Scopes](#4-configuration-scopes)
    ...
    - [Project Scope (Team)](#project-scope-team)
    - [Local Scope (Personal + Project)](#local-scope-personal-project)
  - [5. Authentication](#5-authentication)
    - [OAuth (Recommended)](#oauth-recommended)
    - [API Key (via environment)](#api-key-via-environment)
    - [From settings.json](#from-settingsjson)
...
- [MCP Configuration Files](#mcp-configuration-files)
  - [.mcp.json Structure](#mcpjson-structure)
  - [Example: Multiple Servers](#example-multiple-servers)
  - [Environment Variable Expansion](#environment-variable-expansion)
- [Using MCP Features](#using-mcp-features)
  - [MCP Tools](#mcp-tools)
  - [MCP Resources](#mcp-resources)
  - [MCP Prompts as Slash Commands](#mcp-prompts-as-slash-commands)
- [Managing MCP Servers](#managing-mcp-servers)
  - [Via /mcp Command](#via-mcp-command)
  - [Via Command Line](#via-command-line)
  - [Via Configuration](#via-configuration)
- [Enterprise MCP Configuration](#enterprise-mcp-configuration)
  - [Managed MCP Servers](#managed-mcp-servers)
  - [Allowlist/Denylist](#allowlistdenylist)
- [Plugin-Provided MCP Servers](#plugin-provided-mcp-servers)
- [Import from Claude Desktop](#import-from-claude-desktop)
- [MCP Output Limits](#mcp-output-limits)
- [Security Considerations](#security-considerations)
- [Troubleshooting](#troubleshooting)
  - [Server Not Connecting](#server-not-connecting)
  - [Authentication Failing](#authentication-failing)
  - [Tools Not Available](#tools-not-available)
  - [stdio Server Errors](#stdio-server-errors)
...
- [Example Workflows](#example-workflows)
  - [Workflow 1: Issue to PR](#workflow-1-issue-to-pr)
  - [Workflow 2: Error Investigation](#workflow-2-error-investigation)
  - [Workflow 3: Database Query to Email](#workflow-3-database-query-to-email)
- [Use Claude Code as MCP Server](#use-claude-code-as-mcp-server)
- [Resources](#resources)
...
Provide expert guidance on integrating MCP (Model Context Protocol) servers with Claude Code, including installation, configuration, authentication, and troubleshooting. Use when users want to connect external tools and data sources.
...
- Official docs: `docs/code_claude_com/docs_en_mcp.md`
...
- **Official MCP Docs:** `docs/code_claude_com/docs_en_mcp.md`
- **MCP Website:** https://modelcontextprotocol.io/
