...
Expo Router documentation in `.Codex/skills/frontend/expo/docs/`

Search patterns:
- `Grep "expo router|router|routing" .Codex/skills/frontend/expo/docs/ -i`
- `Grep "navigation|layout|dynamic route" .Codex/skills/frontend/expo/docs/ -i`
- `Grep "app directory|deep link" .Codex/skills/frontend/expo/docs/ -i`
