...
Search patterns:
- `Grep "transaction|/transactions/get|/transactions/sync" .Codex/skills/api/plaid/docs/ -i`
- `Grep "transaction.*category|recurring" .Codex/skills/api/plaid/docs/ -i`
- `Grep "transaction.*webhook|historical.*transaction" .Codex/skills/api/plaid/docs/ -i`
