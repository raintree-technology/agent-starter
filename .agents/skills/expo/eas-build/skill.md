...
EAS Build documentation in `.Codex/skills/frontend/expo/docs/`

Search patterns:
- `Grep "eas build|build.*ios|build.*android" .Codex/skills/frontend/expo/docs/ -i`
- `Grep "eas.json|build profile" .Codex/skills/frontend/expo/docs/ -i`
- `Grep "credentials|code sign" .Codex/skills/frontend/expo/docs/ -i`
