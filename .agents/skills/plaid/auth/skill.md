...
Plaid Auth documentation in `.Codex/skills/api/plaid/docs/`

Search patterns:
- `Grep "auth|account.*routing|ach" .Codex/skills/api/plaid/docs/ -i`
- `Grep "account.*verification|ownership" .Codex/skills/api/plaid/docs/ -i`
- `Grep "balance.*check|instant.*verification" .Codex/skills/api/plaid/docs/ -i`
