# Claude Code Command Builder Full Guide
...
- [Process](#process)
  ...
  - [3. Determine Command Type](#3-determine-command-type)
- [Current State](#current-state)
- [Your Task](#your-task)
  - [4. Generate Command File](#4-generate-command-file)
  - [5. Build Command Workflow](#5-build-command-workflow)
  - [6. Add Argument Handling](#6-add-argument-handling)
  - [7. Add Bash Execution (if needed)](#7-add-bash-execution-if-needed)
- [Context](#context)
- [Your Task](#your-task)
  - [8. Add File References](#8-add-file-references)
  - [9. Configure Thinking Mode (if needed)](#9-configure-thinking-mode-if-needed)
  - [10. Create the File](#10-create-the-file)
  - [11. Test the Command](#11-test-the-command)
- [Frontmatter Reference](#frontmatter-reference)
- [Bash Tool Permissions](#bash-tool-permissions)
- [Argument Patterns](#argument-patterns)
  - [Pattern 1: All Arguments](#pattern-1-all-arguments)
  - [Pattern 2: Positional](#pattern-2-positional)
  - [Pattern 3: Mixed](#pattern-3-mixed)
  - [Pattern 4: With Defaults](#pattern-4-with-defaults)
- [Command Size Guidelines](#command-size-guidelines)
- [Common Command Types](#common-command-types)
  - [1. Git Workflow](#1-git-workflow)
- [Context](#context)
  - [2. Code Generator](#2-code-generator)
  - [3. Analysis Tool](#3-analysis-tool)
  - [4. Deployment Helper](#4-deployment-helper)
  - [5. Documentation Generator](#5-documentation-generator)
- [Example Command Patterns](#example-command-patterns)
- [Troubleshooting](#troubleshooting)
  - [Command Not Found](#command-not-found)
  - [Arguments Not Working](#arguments-not-working)
  - [Bash Commands Not Executing](#bash-commands-not-executing)
  - [Command Not in /help](#command-not-in-help)
- [Best Practices](#best-practices)
  - [DO:](#do)
  - [DON'T:](#dont)
- [Comparison: Commands vs Skills](#comparison-commands-vs-skills)
- [Resources](#resources)
...
Guide users through creating effective Claude Code slash commands with proper structure, argument handling, and workflow design. Use when users want to create or modify custom commands.
...
- Official docs: `docs/code_claude_com/docs_en_slash-commands.md`
- Installed command examples: `.claude/commands/`
- Current docs: use local `docs/` if pulled, otherwise check official Claude Code docs
...
`model`| Specific model to use after checking the current Claude Code model list| `sonnet` or a current model ID
...
```markdown
---
allowed-tools: Bash(jq:*), Bash(node .claude/utils/toon/cli.mjs:*)
...
3. **Convert**: !`node .claude/utils/toon/cli.mjs encode "$1"`
...
- **Official Command Docs:** `docs/code_claude_com/docs_en_slash-commands.md`
