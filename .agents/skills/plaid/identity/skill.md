...
Plaid Identity documentation in `.Codex/skills/api/plaid/docs/`

Search patterns:
- `Grep "identity|/identity/get|account.*holder" .Codex/skills/api/plaid/docs/ -i`
- `Grep "kyc|identity.*verification" .Codex/skills/api/plaid/docs/ -i`
- `Grep "name.*address|owner.*information" .Codex/skills/api/plaid/docs/ -i`
