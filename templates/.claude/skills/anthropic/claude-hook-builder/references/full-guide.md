# Claude Code Hook Builder Full Guide
...
- [Process](#process)
  ...
  - [2. Determine Hook Type](#2-determine-hook-type)
  - [3. Choose Hook Event](#3-choose-hook-event)
  ...
  - [4. Create Hook Script](#4-create-hook-script)
  - [5. Configure in settings.json](#5-configure-in-settingsjson)
  - [6. Hook Input Reference](#6-hook-input-reference)
  - [7. Exit Codes](#7-exit-codes)
  - [8. Test the Hook](#8-test-the-hook)
  - [9. Provide Configuration](#9-provide-configuration)
- [Hook Examples](#hook-examples)
  - [Example 1: Auto-Format Python Files](#example-1-auto-format-python-files)
  - [Example 2: Validate Bash Commands](#example-2-validate-bash-commands)
  - [Example 3: Add Timestamp to Prompts](#example-3-add-timestamp-to-prompts)
  - [Example 4: Auto-Approve Documentation Reads](#example-4-auto-approve-documentation-reads)
  - [Example 5: Prevent Sensitive File Access](#example-5-prevent-sensitive-file-access)
  - [Example 6: Intelligent Stop Hook (Prompt-based)](#example-6-intelligent-stop-hook-prompt-based)
  - [Example 7: Session Setup Hook](#example-7-session-setup-hook)
...
Guide users through creating effective Claude Code hooks for tool validation, automation, and workflow enhancement. Use when users want to create or configure hooks.
...
- Official docs: `docs/code_claude_com/docs_en_hooks.md`
- Hook guide: `docs/code_claude_com/docs_en_hooks-guide.md`
...
- **Official Hook Docs:** `docs/code_claude_com/docs_en_hooks.md`
- **Hook Guide:** `docs/code_claude_com/docs_en_hooks-guide.md`
- **Settings Reference:** `docs/code_claude_com/docs_en_settings.md`
- **Current Docs:** Use local `docs/` if pulled, otherwise check official Claude Code docs
