...
Plaid accounts documentation in `.Codex/skills/api/plaid/docs/`

Search patterns:
- `Grep "account|/accounts/get|/accounts/balance" .Codex/skills/api/plaid/docs/ -i`
- `Grep "balance|account.*type|account.*subtype" .Codex/skills/api/plaid/docs/ -i`
- `Grep "available.*balance|current.*balance" .Codex/skills/api/plaid/docs/ -i`
