...
docpull https://shopify.dev/docs -o .Codex/skills/shopify/docs
```
...
1. **Search for specific topics:**
   ...
   grep -r "checkout" .Codex/skills/shopify/docs/ --include="*.md"
   ```

2. **Read specific documentation:**
   ```bash
   # API docs
   cat .Codex/skills/shopify/docs/shopify/api-admin-graphql.md
   cat .Codex/skills/shopify/docs/shopify/api-storefront.md
   ```

3. **Find implementation guides:**
   ```bash
   # List all guides
   ls .Codex/skills/shopify/docs/shopify/
   ```
...
```bash
# Search all docs
grep -r "search term" .Codex/skills/shopify/docs/

# Find specific topics
ls .Codex/skills/shopify/docs/shopify/

# Read specific guide
cat .Codex/skills/shopify/docs/shopify/webhooks.md
```
