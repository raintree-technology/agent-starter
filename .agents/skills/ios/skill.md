...
iOS development documentation stored in `.Codex/skills/frontend/ios/docs/`
...
2. **Search Documentation**
   ```
   Use Grep to search: Grep "keyword" .Codex/skills/frontend/ios/docs/
   ```

   Common search patterns:
   - SwiftUI: `Grep "swiftui" .Codex/skills/frontend/ios/docs/ -i`
   - UIKit: `Grep "uikit" .Codex/skills/frontend/ios/docs/ -i`
   - Swift language: `Grep "swift" .Codex/skills/frontend/ios/docs/ -i`
   - Xcode: `Grep "xcode" .Codex/skills/frontend/ios/docs/ -i`

3. **Read Relevant Documentation**
   ```
   Use Read to load specific files found in search
   Read .Codex/skills/frontend/ios/docs/[filename].md
   ```
...
1. Search: Grep "list|swiftui" .Codex/skills/frontend/ios/docs/ -i
...
1. Search: Grep "uitableview" .Codex/skills/frontend/ios/docs/ -i
...
1. Search: Grep "optional" .Codex/skills/frontend/ios/docs/ -i
...
1. Search: Grep "build setting|xcode" .Codex/skills/frontend/ios/docs/ -i
...
**Source:** `.Codex/skills/frontend/ios/docs/[filename].md`
```
