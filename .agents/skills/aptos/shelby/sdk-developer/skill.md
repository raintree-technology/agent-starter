...
- SDK guides: `.Codex/skills/blockchain/aptos/docs/sdks_typescript_*.md`
- Protocol architecture: `.Codex/skills/blockchain/aptos/docs/protocol_architecture_*.md`
- API endpoints: `.Codex/skills/blockchain/aptos/docs/apis_rpc_*.md`
