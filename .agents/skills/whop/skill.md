...
docpull https://docs.whop.com -o .Codex/skills/whop/docs
```
...
1. **Search for specific topics:**
   ...
   grep -r "memberships" .Codex/skills/api/whop/docs/ --include="*.md"
   ```

2. **Read specific API references:**
   ```bash
   # API docs are organized by resource
   cat .Codex/skills/api/whop/docs/docs_whop_com/api-reference_memberships_list-memberships.md
   ```

3. **Find integration guides:**
   ```bash
   # Developer guides
   ls .Codex/skills/api/whop/docs/docs_whop_com/developer*
   ```
...
```bash
# Search all docs
grep -r "search term" .Codex/skills/api/whop/docs/

# Search API references only
grep -r "memberships" .Codex/skills/api/whop/docs/docs_whop_com/api-reference*

# List all endpoints
ls .Codex/skills/api/whop/docs/docs_whop_com/api-reference*/
```
