...
4. **Identify type homes**: where does the project already keep shared types? Look for `types/`, `models/`, `schema/`, or a dedicated package (e.g., `packages/types/`, `packages/db/src/schema/` in monorepos).
