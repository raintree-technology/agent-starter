...
docpull https://www.helius.dev/docs -o .Codex/skills/helius/docs
docpull https://docs.stripe.com -o .Codex/skills/stripe/docs
docpull https://supabase.com/docs -o .Codex/skills/supabase/docs
```
...
```bash
# Add skills to .Codex/skills/
# Create commands in .Codex/commands/
...
- Complete documentation in `.Codex/utils/toon/`
...
2. **Copy to project** - `cp -r .Codex/ /my-project/`
...
- Reference `.Codex/DIRECTORY.md` for structure
...
- Template guides: `/docs/` (how to use Codex-starter)
- TOON specification: `.Codex/utils/toon/toon-guide.md`
- API docs: `.Codex/skills/*/docs/` (NOT bundled - pull with docpull)
- Reference: `.Codex/DIRECTORY.md` (complete structure)
...
**Codex:**
- Documentation: https://code.Codex.com/docs
- This Template: See `.Codex/DIRECTORY.md` for complete structure

**Skills Marketplace:**
- SkillsMP: https://skillsmp.com - Browse 13,000+ community skills
- Commands: `/discover-skills` and `/install-skill <url>`
- Installation: Personal (`~/.Codex/skills/`) or project (`.Codex/skills/`)
...
**Summary:** Codex-starter is a production-ready template that gives Codex domain expertise across 40+ areas, TOON token optimization, and a clean pattern for extension. Users can copy the entire `.Codex/` directory or pick specific skills they need.
